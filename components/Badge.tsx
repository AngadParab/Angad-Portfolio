...
// Add custom elements to React Three Fiber JSX namespace for TypeScript
...
function Band({ maxSpeed = 50, minSpeed = 10 }) {
  ...
  const userPhoto = useTexture('/photo.jpg');
        ...
        <RigidBody position={[1.2, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
          ...
          <group
            ...
            <mesh geometry={nodes.card.geometry}>
              ...
              <Decal position={[0, 0.53, 0.02]} rotation={[0, 0, 0]} scale={[0.75, 1.05, 0.1]} map={userPhoto} map-colorSpace={THREE.SRGBColorSpace} />
            </mesh>
